    ...
    constructor(skillAction) {
        ...
        if (this.actionDetail2 !== 0) {
            if (this.actionDetail1 === 710 ||
                ...
                this.trueClause = `${this.targetParameter.buildTargetClause(true)}が持っているマーク [ID: ${this.actionDetail1 - 600}] のスタック数が${this.actionValue3.value}以上の場合、[アクション${this.actionDetail2 % 10}] を使う。`;
            }
            ...
            else if (this.actionDetail1 >= 6000 &&
        ...
        if (this.actionDetail3 !== 0) {
            if (this.actionDetail1 === 710 ||
                ...
                this.falseClause = `${this.targetParameter.buildTargetClause(true)}が持っているマーク [ID: ${this.actionDetail1 - 600}] のスタック数が [${this.actionValue3.value}] 未満の場合、[アクション${this.actionDetail3 % 10}] を使う。`;
            }
            else if (this.actionDetail1 === 700) {
                ...
                this.actionDetail1 < 7000 &&
                this.actionValue3.value === 0) {
                this.falseClause = `${this.targetParameter.buildTargetClause(true)}がマーク [ID: ${this.actionDetail1 - 6000}] を持っている場合、[アクション${this.actionDetail3 % 10}] を使う。`;
            }
            else if (this.actionDetail1 >= 6000 && this.actionDetail1 < 7000) {
